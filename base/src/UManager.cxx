...
void UManager::CreateRun(const char *generator, const char *comment,
                         Int_t aProj, Int_t zProj, Double_t pProj, Int_t aTarg,
                         Int_t zTarg, Double_t pTarg, Double_t bMin,
                         Double_t bMax, Int_t bWeight, Double_t phiMin,
                         Double_t phiMax, Double_t sigma, Int_t nEvents) {
  // Creates the run description, which later can be accessed by GetRun method
  fRun = new URun(generator, comment, aProj, zProj, pProj, aTarg, zTarg, pTarg,
