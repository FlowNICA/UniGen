...
public:
  typedef enum { ePDG = -1, ePluto, eUrQMD, eWerner } EConvention;
...
private:
  // We should use 'EConvention' as the map key type, however this confused
  // rootcint. For the time being use UInt_t instead, hopefully fix this later
  // (FIXME).
