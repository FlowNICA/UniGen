...
int main(int argc, const char **argv) {
  ...
  URun *rUGF =
      new URun("Genesis", rGenesis->GetTitle(), rGenesis->GetAProj(),
               rGenesis->GetZProj(), rGenesis->GetPProj(), rGenesis->GetATarg(),
               rGenesis->GetZTarg(), rGenesis->GetPTarg(), bMin, bMax, bWeight,
               phiMin, phiMax, sigma, tGenesis->GetEntries());
  ...
  if ((argc == 4) && (tGenesis->GetEntries() > atoi(argv[3])))
    nevents = atoi(argv[3]);
